...
export const SidebarLink = ({variant, symbol, href, preview, disabled, ...props} : SidebarLinkProps) => {
    ...
    return (
        <div
            ...
            className={cx(sidebarLinkVariants({variant: variant ? variant : isActive ? "active" : disabled ? "disabled" :  "default"}), "group/sidebar-link flex justify-between items-center relative overflow-clip")}
            onClick={handleClick}
