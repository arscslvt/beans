...
function BoltSlash1(props: IconProps) {
	...
	<g fill={fill}>
		<path d="m3.734,10.25h4.016l2.5-2.5h-1l.604-5.979c.037-.26-.299-.394-.451-.18L3.531,9.855c-.118.166,0,.395.204.395Z" fill={secondaryfill} opacity=".3" strokeWidth="0"/>
		...
		<line fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth} x1="2" x2="16" y1="16" y2="2"/>
	</g>
</svg>
	);
}

export default BoltSlash1;