...
function CircleInfo1(props: IconProps) {
	...
	<g fill={fill}>
		...
		<path d="M9 12.819V8.25" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M9 6.75C8.448 6.75 8 6.301 8 5.75C8 5.199 8.448 4.75 9 4.75C9.552 4.75 10 5.199 10 5.75C10 6.301 9.552 6.75 9 6.75Z" fill={fill}/>
	</g>
</svg>
	);
}

export default CircleInfo1;