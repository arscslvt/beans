...
export default function TemplateButton({
  ...
  return (
    <button
      ...
      {...props}
    >
      <div className="w-auto h-8 aspect-square rounded-md bg-gradient-to-tr from-indigo-400 to-accent-darker text-accent-foreground grid place-content-center border border-accent-darker/80 shadow-inner shadow-background/30">
